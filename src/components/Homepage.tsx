...
export function Homepage() {
  ...
  return (
    ...
    >
      ...
      {/* Large text - mobile: left-aligned at bottom, desktop: centered */}
      <div
        className="absolute inset-0 flex items-end md:items-center justify-start md:justify-center z-1 px-12 md:pb-0 md:pt-0"
        style={{
          paddingBottom: isMobile ? 'calc(5dvh + env(safe-area-inset-bottom))' : undefined,
        }}
      >
